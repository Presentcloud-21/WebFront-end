:root {
    ...
    --checkbox-disabled-label-color: var(--color-text1-4, #333333);
    ...
    --menu-btn-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --split-btn-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --search-normal-primary-l-height: var(--s-15, 60px);
    ...
    --search-normal-primary-m-height: var(--s-10, 40px);
    ...
    --search-normal-secondary-l-height: var(--s-15, 60px);
    ...
    --tree-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --switch-size-m-radius-container: var(--corner-3, 16px);
    
    
    --switch-size-m-trigger: var(--s-6, 24px);
    
    
    --switch-size-m-radius-trigger: var(--corner-3, 16px);
    
    
    --switch-size-s-width: var(--s-11, 44px);
    
    
    --switch-size-s-radius-container: var(--corner-3, 16px);
    
    
    --switch-size-s-trigger: var(--s-5, 20px);
    
    
    --switch-size-s-radius-trigger: var(--corner-3, 16px);
    
    
    --switch-border-width-container: var(--line-1, 1px);
    ...
    --switch-normal-off-bg-color: var(--color-white, #FFFFFF);
    
    
    --switch-hover-off-bg-color: var(--color-fill1-2, #F2F3F7);
    
    
    --switch-disabled-off-bg-color: var(--color-fill1-1, #F7F8FA);
    ...
    --switch-handle-disabled-border-color: var(--color-line1-1, #E6E7EB);
    ...
    --switch-normal-off-border-color: var(--color-line1-3, #C4C6CF);
    
    
    --switch-hover-off-border-color: var(--color-line1-3, #C4C6CF);
    ...
    --menu-padding-horizontal: var(--s-5, 20px);
    ...
    --menu-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --btn-size-s-height: var(--s-5, 20px);
    ...
    --btn-size-s-font: var(--font-size-caption, 10px);
    ...
    --select-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --progress-line-radius-l: var(--corner-3, 16px);
    
    
    --progress-line-radius-m: var(--corner-3, 16px);
    
    
    --progress-line-radius-s: var(--corner-3, 16px);
    ...
    --collapse-unfold-icon-content: var(--icon-reset, $icon-reset);
    ...
    --nav-group-font-size: var(--font-size-subhead, 16px);
    ...
    --nav-secondary-item-opened-bg-color: var(--color-brand1-9, #3E71F7);
    ...
    --nav-normal-item-opened-bg-color: var(--color-fill1-2, #F2F3F7);
